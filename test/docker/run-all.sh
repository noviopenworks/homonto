#!/bin/sh
# Runs all triple-binary Docker E2E suites against disposable state, printing
...
SUITES="homonto-core homonto-expanded onto-lifecycle to-lifecycle release-packaging"
