...
- [x] validateFrameworkResources accepts remote:<url> with a required digest
...
- [x] Resolve declared remote frameworks through remote.Resolver (fetch → verify
...
## 3. E2E + verify
- [x] E2E: a digest-pinned remote:file:// framework's skill is materialized by
