...
- [x] Add a no-follow, root-confined write function for `.homonto` control-plane
...
- [x] Acquire a project-scoped exclusive lock (`.homonto/apply.lock`) at apply
      start; a second concurrent apply fails fast; released on exit. Test.
## 3. F31 locator credential redaction
- [x] Reject or redact credentials in remote locators before they reach errors or
