...
|---|---|---|
| `builtin:<name>` | the bundled catalog (materialized at `.homonto/catalog/subagents/<name>.md`) | ships: `onto-reviewer`, `onto-explorer`, `onto-implementer`, `onto-skeptic`, `comet-navigator` |
