...
|---|---|---|
| `builtin:<name>` | the bundled catalog (materialized at `.homonto/catalog/subagents/<name>.md`) | ships `onto-reviewer`, `onto-explorer`, `onto-implementer`, `onto-skeptic`, plus the `to-*` twins the to framework installs |
