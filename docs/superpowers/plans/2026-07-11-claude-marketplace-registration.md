...
- [ ] 3.2 Update `docs/roadmap.md` (v1.2 COMPLETE: declare + enable/disable + config + marketplace) + README `[marketplaces.claude.<name>]` example. No over-claim.
