...
- [x] 1.1 Add `scripts/build-release.sh` (`#!/usr/bin/env bash`, `set -eu`),
...
- [x] 1.2 Rewire `.github/workflows/release.yml`: replace the "build release
...
- [x] 1.3 Extend `.github/workflows/ci.yml`: after the existing homonto
...
- [x] 2.1 Local packaging E2E: run `bash scripts/build-release.sh v0.0.0-test`
...
- [x] 2.2 Update `docs/roadmap.md`: #5 dual-binary release packaging landed — the
